...
Covered (✅ + 🟡 + 🧪) = **551 / 754 (73%)**; consciously waived (🚫) = **202 (27%)** — overwhelmingly cases that require a real canvas / editor / browser permission (React Flow viewport geometry, live Tiptap DOM state, File System Access dialog). One open gap: HOOK-6.5-07 (`createDocument` unit test).
