...
### 7.3.c Failure modes
- **PERSIST-7.3-15** 🚫 **Revoked permission surfaces error.** — N/A post-Tauri: FSA permission semantics retired in MVP-1d (`0f5e152`); native FS has no equivalent revocation surface to test
