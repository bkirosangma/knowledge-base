...
3. Derive a **topic-slug** from the topic for the filename:
   - Lowercase the topic
...
Documents and diagrams generated in this vault.

| Date | Type | Topic | File | Notes |
|------|------|-------|------|-------|
| <YYYY-MM-DD> | document | <Topic> | `<relative-path-from-vault-root>` | Generated by knowledge-base |
```
