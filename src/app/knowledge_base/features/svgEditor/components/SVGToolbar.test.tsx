...
describe('SVGToolbar', () => {
  ...
  it('SVG-6.3-01: renders all tool buttons', () => {
    ...
    expect(screen.getByLabelText('Ellipse (E)')).toBeInTheDocument();
    expect(screen.getByLabelText('Line (L)')).toBeInTheDocument();
    expect(screen.getByLabelText('Path (P)')).toBeInTheDocument();
  ...
  it('SVG-6.3-02: calls onToolChange with correct tool when a tool button is clicked', () => {
    ...
    fireEvent.click(screen.getByLabelText('Rectangle (R)'));
  ...
  it('SVG-6.3-04: calls onZoomFit when Fit button is clicked', () => {
    ...
    fireEvent.click(screen.getByLabelText('Fit'));
