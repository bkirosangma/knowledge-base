...
function makeProps(
  ...
  return {
    ...
    commitLabel: vi.fn(),
    attachmentCountsForNode: vi.fn(() => ({ docs: 0, diagrams: 0, svgs: 0, tabs: 0 })),
    attachmentCountsForConnection: vi.fn(() => ({ docs: 0, diagrams: 0, svgs: 0, tabs: 0 })),
    openAttachmentPreviewFor: vi.fn(),
