...
export const initialNodes: NodeData[] = [
  { id: "grafana", label: "Grafana Dashboards", icon: Monitor, x: 640, y: 85, w: 210, layer: "l1" },
  { id: "querier", label: "Thanos Querier", sub: "Deduplication & Stream Merging", icon: Network, x: 640, y: 220, w: 210, layer: "l2" },
  { id: "store", label: "Thanos Store Gateway (HA Pair)", icon: Database, x: 390, y: 300, w: 210, layer: "l2" },
  { id: "compactor", label: "Thanos Compactor", sub: "Retention Enforcement & Downsampling", icon: Archive, x: 890, y: 300, w: 210, layer: "l2" },
  { id: "s3", label: "S3: metrics-lake bucket", icon: Cloud, x: 640, y: 470, w: 210, layer: "l3" },
  { id: "sidecar1eu", label: "Thanos Sidecar", icon: Database, x: 260, y: 650, w: 130, layer: "l4" },
  { id: "pv1eu", label: "TSDB Volume", icon: Archive, x: 120, y: 650, w: 110, layer: "l4" },
  { id: "prom1eu", label: "Prometheus 1-eu (Rep A)", icon: Database, x: 190, y: 750, w: 190, layer: "l4" },
  { id: "sidecar2eu", label: "Thanos Sidecar", icon: Database, x: 540, y: 650, w: 130, layer: "l4" },
  { id: "pv2eu", label: "TSDB Volume", icon: Archive, x: 400, y: 650, w: 110, layer: "l4" },
  { id: "prom2eu", label: "Prometheus 2-eu (Rep B)", icon: Database, x: 470, y: 750, w: 190, layer: "l4" },
  { id: "sidecar1us", label: "Thanos Sidecar", icon: Database, x: 880, y: 650, w: 130, layer: "l4" },
  { id: "pv1us", label: "TSDB Volume", icon: Archive, x: 740, y: 650, w: 110, layer: "l4" },
  { id: "prom1us", label: "Prometheus 1-us (Rep A)", icon: Database, x: 810, y: 750, w: 190, layer: "l4" },
  { id: "sidecar2us", label: "Thanos Sidecar", icon: Database, x: 1160, y: 650, w: 130, layer: "l4" },
  { id: "pv2us", label: "TSDB Volume", icon: Archive, x: 1020, y: 650, w: 110, layer: "l4" },
  { id: "prom2us", label: "Prometheus 2-us (Rep B)", icon: Database, x: 1090, y: 750, w: 190, layer: "l4" },
  { id: "appeu", label: "Spring Boot Microservices (EU)", icon: Settings, x: 330, y: 860, w: 230, layer: "l4" },
  { id: "appus", label: "Spring Boot Microservices (US)", icon: Settings, x: 950, y: 860, w: 230, layer: "l4" },
];
